...
function growBox() {
    console.log("Growing Box...");
    /* ^ Variable width set at the beginning of program; 'width = 100px'
    /* Setting a variable for box size, then using style setProperty to assign it */
    width  += 10;
    document.getElementById("grow-box").style.setProperty('--dim', width + "px");

    /*For Homework*/
    /*
    Running man: Change var margin-left
    Fund Raising: Create a gradient and update the 'dividing' number using css vars
    */
}
